...
<script>
    ...
    var setting = {
        ...
        async: {
            enable: true,
            url: '${basePath}/permission/enterprise/' + enterpriseId
        },
        data: {
            simpleData: {
                enable: true
    ...
    function permissionSubmit() {
        $.ajax({
            type: 'post',
            url: '${basePath}/enterprise/permission/' + enterpriseId,
            data: {datas: JSON.stringify(changeDatas), enterpriseId: enterpriseId},
            dataType:'json',
