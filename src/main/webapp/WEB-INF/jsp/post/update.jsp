    ...
    <form id="updateForm" method="post">
        ...
        <div class="radio">
            <div class="radio radio-inline radio-info">
                <input id="type_1" type="radio" name="manager" value="1" <c:if test="${staffingPost.manager==true}">checked</c:if>>
                <label for="type_1">管理岗 </label>
            </div>
            <div class="radio radio-inline radio-warning">
                <input id="type_0" type="radio" name="manager" value="0" <c:if test="${staffingPost.manager==false}">checked</c:if>>
