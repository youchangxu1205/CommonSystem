...
<head>
    ...
    <link href="${basePath}/resources/zheng-admin/plugins/font-awesome-4.7.0/css/font-awesome.min.css" rel="stylesheet"/>
    ...
    <aside id="sidebar">
        ...
        <div class="s-profile">
            <a class="waves-effect waves-light" href="javascript:;">
                <div class="sp-pic">
                    <img src="${basePath}${staffingEmp.empAvatarUrl}"/>
                </div>
                <div class="sp-info">
                    ${staffingEmp.empName}，您好！
